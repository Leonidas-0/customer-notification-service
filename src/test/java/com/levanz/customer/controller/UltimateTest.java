...
class UltimateTest {
    ...
    void fullApplicationFlow() throws Exception {
        ...
        Map<String, Object> custMap = json.readValue(
            custJson, new TypeReference<>() {});
        ...
        assertThat(addrs.get(0).get("id")).isEqualTo(addrId.intValue());
        assertThat(prefs).hasSize(1);
        assertThat(prefs.get(0).get("id")).isEqualTo(prefId.intValue());
        assertThat(notifs).hasSize(1);
        assertThat(notifs.get(0).get("id")).isEqualTo(notifId.intValue());
    ...
    private String obtainJwt() throws Exception {
        String creds = json.writeValueAsString(
        ...
        String resp = mvc.perform(post("/api/auth/login")
            ...
            .andReturn().getResponse().getContentAsString();
        Map<String,String> map = json.readValue(
    ...
    private Long createAddress(String jwt, Long custId,
                               String city, String street, String zip) throws Exception {
        String body = json.writeValueAsString(
    ...
    private Long createPreference(String jwt, Long custId,
                                  String channel, boolean optIn) throws Exception {
        String body = json.writeValueAsString(
            Map.of("channel",channel,"optedIn",optIn)
        );
    ...
    private Long createNotification(String jwt, Long custId,
                                    NotificationStatus status) throws Exception {
        String body = json.writeValueAsString(
